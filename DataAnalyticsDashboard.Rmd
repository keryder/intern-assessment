...
# creates a dropdown menu for counting cycles
dropdown <- renderUI({
  data <- waterData()
  data <- unique(data$Date)
  selectInput("cycles_select", "Cycles Since:", data)
})
```

<div style= "display: flex; gap: 20px">
  <div style="border: 3px solid #ccc; padding: 0px 5px; flex: 1;">
**Last Runtime**: `r getRuntime`
  </div>
  <div style="border: 3px solid #ccc; padding: 0px 5px; flex: 1;">
